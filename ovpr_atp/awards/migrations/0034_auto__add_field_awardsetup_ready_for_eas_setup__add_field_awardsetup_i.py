...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AwardSetup.ready_for_eas_setup'
        db.add_column(u'awards_awardsetup', 'ready_for_eas_setup',
    ...
    def backwards(self, orm):
        # Deleting field 'AwardSetup.ready_for_eas_setup'
        db.delete_column(u'awards_awardsetup', 'ready_for_eas_setup')
    ...
    models = {
        ...
        u'awards.awardsetup': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imported_to_eas': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
