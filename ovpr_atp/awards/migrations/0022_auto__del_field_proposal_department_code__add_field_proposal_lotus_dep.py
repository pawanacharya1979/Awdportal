...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Proposal.lotus_department_code'
        db.add_column(u'awards_proposal', 'lotus_department_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'Proposal.lotus_agency_name'
        db.add_column(u'awards_proposal', 'lotus_agency_name',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Proposal.lotus_department_code'
        db.delete_column(u'awards_proposal', 'lotus_department_code')

        # Deleting field 'Proposal.lotus_agency_name'
        db.delete_column(u'awards_proposal', 'lotus_agency_name')
