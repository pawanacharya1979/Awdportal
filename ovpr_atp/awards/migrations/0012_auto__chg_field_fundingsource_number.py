...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FundingSource.number'
        db.alter_column(u'awards_fundingsource', 'number', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'FundingSource.number'
        db.alter_column(u'awards_fundingsource', 'number', self.gf('django.db.models.fields.CharField')(max_length=1))
