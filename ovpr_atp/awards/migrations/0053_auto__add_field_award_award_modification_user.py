...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Award.award_modification_user'
        db.add_column(u'awards_award', 'award_modification_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Award.award_modification_user'
        db.delete_column(u'awards_award', 'award_modification_user_id')
