...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Award.award_dual_negotiation'
        db.add_column(u'awards_award', 'award_dual_negotiation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Award.award_dual_setup'
        db.add_column(u'awards_award', 'award_dual_setup',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Award.award_dual_negotiation'
        db.delete_column(u'awards_award', 'award_dual_negotiation')

        # Deleting field 'Award.award_dual_setup'
        db.delete_column(u'awards_award', 'award_dual_setup')
