...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for award_setup in orm.AwardSetup.objects.filter(~Q(ready_for_eas_setup=None)):
            award_setup.ready_for_eas_setup = None
            award_setup.save()

        for pta_number in orm.PTANumber.objects.filter(~Q(ready_for_eas_setup=None)):
            pta_number.ready_for_eas_setup = None
            pta_number.save()
