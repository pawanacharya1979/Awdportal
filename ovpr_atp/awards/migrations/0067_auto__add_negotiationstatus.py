...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NegotiationStatus'
        db.create_table(u'awards_negotiationstatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('negotiation_status', self.gf('django.db.models.fields.CharField')(max_length=3, blank=True)),
            ('negotiation_status_changed_user', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ...
            ('negotiation_status_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'awards', ['NegotiationStatus'])


    def backwards(self, orm):
        # Deleting model 'NegotiationStatus'
        db.delete_table(u'awards_negotiationstatus')
