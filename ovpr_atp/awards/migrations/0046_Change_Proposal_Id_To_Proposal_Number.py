...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for proposal in orm.Proposal.objects.all():
            if proposal.submission_date and proposal.proposal_id:
                date_string = proposal.submission_date.strftime("%y")
                proposal.proposal_number = '{0}-{1}'.format(date_string, proposal.proposal_id)
                proposal.save()
