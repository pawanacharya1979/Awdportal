...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PTANumber.is_edited'
        db.add_column(u'awards_ptanumber', 'is_edited',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PTANumber.is_edited'
        db.delete_column(u'awards_ptanumber', 'is_edited')
