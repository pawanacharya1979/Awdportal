...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PrincipalInvestigator.county'
        db.delete_column(u'awards_principalinvestigator', 'county')

        # Deleting field 'PrincipalInvestigator.city'
        db.delete_column(u'awards_principalinvestigator', 'city')

        # Deleting field 'PrincipalInvestigator.state'
        db.delete_column(u'awards_principalinvestigator', 'state')

        # Deleting field 'PrincipalInvestigator.zip_code'
        db.delete_column(u'awards_principalinvestigator', 'zip_code')

        # Deleting field 'PrincipalInvestigator.street1'
        db.delete_column(u'awards_principalinvestigator', 'street1')

        # Deleting field 'PrincipalInvestigator.street2'
        db.delete_column(u'awards_principalinvestigator', 'street2')

        # Deleting field 'PrincipalInvestigator.country'
        db.delete_column(u'awards_principalinvestigator', 'country')


        # Changing field 'AwardManager.gwid'
        db.alter_column(u'awards_awardmanager', 'gwid', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'AwardSetup.short_name'
        db.alter_column(u'awards_awardsetup', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):
        # Adding field 'PrincipalInvestigator.county'
        db.add_column(u'awards_principalinvestigator', 'county',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'PrincipalInvestigator.city'
        db.add_column(u'awards_principalinvestigator', 'city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'PrincipalInvestigator.state'
        db.add_column(u'awards_principalinvestigator', 'state',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PrincipalInvestigator.zip_code'
        db.add_column(u'awards_principalinvestigator', 'zip_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'PrincipalInvestigator.street1'
        db.add_column(u'awards_principalinvestigator', 'street1',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'PrincipalInvestigator.street2'
        db.add_column(u'awards_principalinvestigator', 'street2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'PrincipalInvestigator.country'
        db.add_column(u'awards_principalinvestigator', 'country',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'AwardManager.gwid'
        raise RuntimeError("Cannot reverse this migration. 'AwardManager.gwid' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'AwardManager.gwid'
        db.alter_column(u'awards_awardmanager', 'gwid', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'AwardSetup.short_name'
        db.alter_column(u'awards_awardsetup', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=250))
