...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AwardAcceptance.award_setup_priority'
        db.add_column(u'awards_awardacceptance', 'award_setup_priority',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2, blank=True),
                      keep_default=False)

        # Adding field 'AwardAcceptance.priority_by_director'
        db.add_column(u'awards_awardacceptance', 'priority_by_director',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AwardAcceptance.award_setup_priority'
        db.delete_column(u'awards_awardacceptance', 'award_setup_priority')

        # Deleting field 'AwardAcceptance.priority_by_director'
        db.delete_column(u'awards_awardacceptance', 'priority_by_director')
    ...
    models = {
        ...
        u'awards.award': {
            ...
            'award_dual_modification': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'award_dual_negotiation': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'award_dual_setup': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'common_modification': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'creation_date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'extracted_to_eas': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'send_to_modification': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'send_to_setup': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'awards.awardacceptance': {
            ...
            'award_setup_priority': ('django.db.models.fields.CharField', [], {'max_length': '2', 'blank': 'True'}),
            ...
            'priority_by_director': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'awards.negotiationstatus': {
            'Meta': {'object_name': 'NegotiationStatus'},
            'award': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['awards.Award']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'negotiation_notes': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'negotiation_status': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'negotiation_status_changed_user': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'negotiation_status_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'})
        },
        ...
        u'awards.ptanumber': {
            ...
            'project_title': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
            'pta_number_updated': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'ready_for_eas_setup': ('django.db.models.fields.CharField', [], {'max_length': '3', 'blank': 'True'}),
            'short_name': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            'sp_type': ('django.db.models.fields.CharField', [], {'max_length': '3', 'blank': 'True'}),
            'sponsor_award_number': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
