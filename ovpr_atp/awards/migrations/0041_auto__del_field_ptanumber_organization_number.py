...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PTANumber.organization_number'
        db.delete_column(u'awards_ptanumber', 'organization_number')


    def backwards(self, orm):
        # Adding field 'PTANumber.organization_number'
        db.add_column(u'awards_ptanumber', 'organization_number',
