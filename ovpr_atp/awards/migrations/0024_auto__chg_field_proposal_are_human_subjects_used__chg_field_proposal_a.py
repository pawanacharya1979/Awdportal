...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Proposal.are_human_subjects_used'
        db.alter_column(u'awards_proposal', 'are_human_subjects_used', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'Proposal.are_vertebrate_animals_used'
        db.alter_column(u'awards_proposal', 'are_vertebrate_animals_used', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

    def backwards(self, orm):

        # Changing field 'Proposal.are_human_subjects_used'
        db.alter_column(u'awards_proposal', 'are_human_subjects_used', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Proposal.are_vertebrate_animals_used'
        db.alter_column(u'awards_proposal', 'are_vertebrate_animals_used', self.gf('django.db.models.fields.IntegerField')(null=True))
