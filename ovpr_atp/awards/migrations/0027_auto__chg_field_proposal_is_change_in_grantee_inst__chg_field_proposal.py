...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Proposal.is_change_in_grantee_inst'
        db.alter_column(u'awards_proposal', 'is_change_in_grantee_inst', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'Proposal.is_status_waiver_required'
        db.alter_column(u'awards_proposal', 'is_status_waiver_required', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'Proposal.cost_shr_vol_is_committed'
        db.alter_column(u'awards_proposal', 'cost_shr_vol_is_committed', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'Proposal.will_involve_shipment'
        db.alter_column(u'awards_proposal', 'will_involve_shipment', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'Proposal.is_haz_mat'
        db.alter_column(u'awards_proposal', 'is_haz_mat', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'Proposal.will_involve_foreign_contract'
        db.alter_column(u'awards_proposal', 'will_involve_foreign_contract', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'Proposal.cost_shr_mand_is_committed'
        db.alter_column(u'awards_proposal', 'cost_shr_mand_is_committed', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'Proposal.is_irb_review_pending'
        db.alter_column(u'awards_proposal', 'is_irb_review_pending', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'Proposal.is_cost_shr_auth_attached'
        db.alter_column(u'awards_proposal', 'is_cost_shr_auth_attached', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'Proposal.is_subcontract'
        db.alter_column(u'awards_proposal', 'is_subcontract', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'Proposal.is_iacuc_review_pending'
        db.alter_column(u'awards_proposal', 'is_iacuc_review_pending', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'Proposal.is_signed_ip_waiver_attached'
        db.alter_column(u'awards_proposal', 'is_signed_ip_waiver_attached', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'Proposal.will_involve_foreign_nationals'
        db.alter_column(u'awards_proposal', 'will_involve_foreign_nationals', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'Proposal.is_agency_cert_doc_attached'
        db.alter_column(u'awards_proposal', 'is_agency_cert_doc_attached', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'Proposal.is_signed_coi_disc_attached'
        db.alter_column(u'awards_proposal', 'is_signed_coi_disc_attached', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

    def backwards(self, orm):

        # Changing field 'Proposal.is_change_in_grantee_inst'
        db.alter_column(u'awards_proposal', 'is_change_in_grantee_inst', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Proposal.is_status_waiver_required'
        db.alter_column(u'awards_proposal', 'is_status_waiver_required', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Proposal.cost_shr_vol_is_committed'
        db.alter_column(u'awards_proposal', 'cost_shr_vol_is_committed', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Proposal.will_involve_shipment'
        db.alter_column(u'awards_proposal', 'will_involve_shipment', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Proposal.is_haz_mat'
        db.alter_column(u'awards_proposal', 'is_haz_mat', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Proposal.will_involve_foreign_contract'
        db.alter_column(u'awards_proposal', 'will_involve_foreign_contract', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Proposal.cost_shr_mand_is_committed'
        db.alter_column(u'awards_proposal', 'cost_shr_mand_is_committed', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Proposal.is_irb_review_pending'
        db.alter_column(u'awards_proposal', 'is_irb_review_pending', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Proposal.is_cost_shr_auth_attached'
        db.alter_column(u'awards_proposal', 'is_cost_shr_auth_attached', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Proposal.is_subcontract'
        db.alter_column(u'awards_proposal', 'is_subcontract', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Proposal.is_iacuc_review_pending'
        db.alter_column(u'awards_proposal', 'is_iacuc_review_pending', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Proposal.is_signed_ip_waiver_attached'
        db.alter_column(u'awards_proposal', 'is_signed_ip_waiver_attached', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Proposal.will_involve_foreign_nationals'
        db.alter_column(u'awards_proposal', 'will_involve_foreign_nationals', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Proposal.is_agency_cert_doc_attached'
        db.alter_column(u'awards_proposal', 'is_agency_cert_doc_attached', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Proposal.is_signed_coi_disc_attached'
        db.alter_column(u'awards_proposal', 'is_signed_coi_disc_attached', self.gf('django.db.models.fields.IntegerField')(null=True))
