...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Award.send_to_modification'
        db.add_column(u'awards_award', 'send_to_modification',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Award.send_to_setup'
        db.add_column(u'awards_award', 'send_to_setup',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Award.common_modification'
        db.add_column(u'awards_award', 'common_modification',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Award.send_to_modification'
        db.delete_column(u'awards_award', 'send_to_modification')

        # Deleting field 'Award.send_to_setup'
        db.delete_column(u'awards_award', 'send_to_setup')

        # Deleting field 'Award.common_modification'
        db.delete_column(u'awards_award', 'common_modification')
