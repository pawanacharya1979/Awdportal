...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subaward.ffata_submitted'
        db.add_column(u'awards_subaward', 'ffata_submitted',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Subaward.tech_report_due'
        db.add_column(u'awards_subaward', 'tech_report_due',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Subaward.tech_report_received'
        db.add_column(u'awards_subaward', 'tech_report_received',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subaward.ffata_submitted'
        db.delete_column(u'awards_subaward', 'ffata_submitted')

        # Deleting field 'Subaward.tech_report_due'
        db.delete_column(u'awards_subaward', 'tech_report_due')

        # Deleting field 'Subaward.tech_report_received'
        db.delete_column(u'awards_subaward', 'tech_report_received')
