...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Award.award_dual_modification'
        db.add_column(u'awards_award', 'award_dual_modification',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Award.award_dual_modification'
        db.delete_column(u'awards_award', 'award_dual_modification')
