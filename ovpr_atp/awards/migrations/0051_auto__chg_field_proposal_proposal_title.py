...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Proposal.proposal_title'
        db.alter_column(u'awards_proposal', 'proposal_title', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'Proposal.proposal_title'
        db.alter_column(u'awards_proposal', 'proposal_title', self.gf('django.db.models.fields.CharField')(max_length=50))
