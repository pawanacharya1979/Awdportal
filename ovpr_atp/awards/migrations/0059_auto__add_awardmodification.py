...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'awards_awardmodification', (
            (u'awardsetup_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['awards.AwardSetup'], unique=True, primary_key=True)),
        ))
    ...
    models = {
        ...
        u'awards.awardmodification': {
            'Meta': {'object_name': 'AwardModification', '_ormbases': [u'awards.AwardSetup']},
            u'awardsetup_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['awards.AwardSetup']", 'unique': 'True', 'primary_key': 'True'})
        },
