...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AwardSetup.eas_award_type'
        db.add_column(u'awards_awardsetup', 'eas_award_type',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AwardSetup.eas_award_type'
        db.delete_column(u'awards_awardsetup', 'eas_award_type')
    ...
    models = {
        ...
        u'awards.awardsetup': {
            ...
            'eas_award_type': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
