...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for negotiation in orm.AwardNegotiation.objects.filter(~Q(date_received=None)):
            negotiation.date_assigned = datetime.datetime.combine(negotiation.date_received, datetime.datetime.min.time())
            negotiation.save()

    def backwards(self, orm):
        for negotiation in orm.AwardNegotiation.objects.filter(~Q(date_assigned=None)):
            negotiation.date_received = negotiation.date_assigned.date()
            negotiation.save()
