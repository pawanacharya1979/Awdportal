...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'FundingSources'
        db.delete_table(u'awards_fundingsources')

        # Adding model 'FundingSource'
        db.create_table(u'awards_fundingsource', (
        ...
        db.send_create_signal(u'awards', ['FundingSource'])


    def backwards(self, orm):
        # Adding model 'FundingSources'
        db.create_table(u'awards_fundingsources', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('number', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('active', self.gf('django.db.models.fields.BooleanField')()),
        ...
        db.send_create_signal(u'awards', ['FundingSources'])

        # Deleting model 'FundingSource'
        db.delete_table(u'awards_fundingsource')
