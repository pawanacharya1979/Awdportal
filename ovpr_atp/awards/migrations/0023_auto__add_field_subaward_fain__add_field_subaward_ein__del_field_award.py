...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subaward.fain'
        db.add_column(u'awards_subaward', 'fain',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Subaward.ein'
        db.add_column(u'awards_subaward', 'ein',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)
        ...
        # Adding field 'AwardSetup.nine_ninety_form_needed'
        db.add_column(u'awards_awardsetup', 'nine_ninety_form_needed',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AwardSetup.wait_for'
        db.add_column(u'awards_awardsetup', 'wait_for',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subaward.fain'
        db.delete_column(u'awards_subaward', 'fain')

        # Deleting field 'Subaward.ein'
        db.delete_column(u'awards_subaward', 'ein')
        ...
        # Deleting field 'AwardSetup.nine_ninety_form_needed'
        db.delete_column(u'awards_awardsetup', 'nine_ninety_form_needed')

        # Deleting field 'AwardSetup.wait_for'
        db.delete_column(u'awards_awardsetup', 'wait_for')
