...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CFDANumber'
        db.create_table(u'awards_cfdanumber', (
            ('flex_value', self.gf('django.db.models.fields.CharField')(unique=True, max_length=150, primary_key=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=240)),
            ('end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'awards', ['CFDANumber'])


    def backwards(self, orm):
        # Deleting model 'CFDANumber'
        db.delete_table(u'awards_cfdanumber')
