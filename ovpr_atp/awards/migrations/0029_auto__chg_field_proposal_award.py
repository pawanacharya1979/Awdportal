...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Proposal.award'
        db.alter_column(u'awards_proposal', 'award_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['awards.Award'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Proposal.award'
        db.alter_column(u'awards_proposal', 'award_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['awards.Award'], null=True))
