...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PTANumber.agency_name'
        db.add_column(u'awards_ptanumber', 'agency_name',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['awards.FundingSource'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'PTANumber.department_name'
        db.add_column(u'awards_ptanumber', 'department_name',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['awards.AwardOrganization'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'PTANumber.project_title'
        db.add_column(u'awards_ptanumber', 'project_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'PTANumber.who_is_prime'
        db.add_column(u'awards_ptanumber', 'who_is_prime',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['awards.PrimeSponsor'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'PTANumber.allowed_cost_schedule'
        db.add_column(u'awards_ptanumber', 'allowed_cost_schedule',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['awards.AllowedCostSchedule'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'PTANumber.award_template'
        db.add_column(u'awards_ptanumber', 'award_template',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['awards.AwardTemplate'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'PTANumber.cfda_number'
        db.add_column(u'awards_ptanumber', 'cfda_number',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['awards.CFDANumber'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'PTANumber.eas_award_type'
        db.add_column(u'awards_ptanumber', 'eas_award_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2, blank=True),
                      keep_default=False)

        # Adding field 'PTANumber.start_date'
        db.add_column(u'awards_ptanumber', 'start_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PTANumber.end_date'
        db.add_column(u'awards_ptanumber', 'end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PTANumber.final_reports_due_date'
        db.add_column(u'awards_ptanumber', 'final_reports_due_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PTANumber.federal_negotiated_rate'
        db.add_column(u'awards_ptanumber', 'federal_negotiated_rate',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['awards.FedNegRate'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'PTANumber.indirect_cost_schedule'
        db.add_column(u'awards_ptanumber', 'indirect_cost_schedule',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['awards.IndirectCost'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'PTANumber.sp_type'
        db.add_column(u'awards_ptanumber', 'sp_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=3, blank=True),
                      keep_default=False)

        # Adding field 'PTANumber.short_name'
        db.add_column(u'awards_ptanumber', 'short_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'PTANumber.award_setup_complete'
        db.add_column(u'awards_ptanumber', 'award_setup_complete',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PTANumber.agency_award_number'
        db.add_column(u'awards_ptanumber', 'agency_award_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'PTANumber.sponsor_award_number'
        db.add_column(u'awards_ptanumber', 'sponsor_award_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'PTANumber.eas_status'
        db.add_column(u'awards_ptanumber', 'eas_status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PTANumber.agency_name'
        db.delete_column(u'awards_ptanumber', 'agency_name_id')

        # Deleting field 'PTANumber.department_name'
        db.delete_column(u'awards_ptanumber', 'department_name_id')

        # Deleting field 'PTANumber.project_title'
        db.delete_column(u'awards_ptanumber', 'project_title')

        # Deleting field 'PTANumber.who_is_prime'
        db.delete_column(u'awards_ptanumber', 'who_is_prime_id')

        # Deleting field 'PTANumber.allowed_cost_schedule'
        db.delete_column(u'awards_ptanumber', 'allowed_cost_schedule_id')

        # Deleting field 'PTANumber.award_template'
        db.delete_column(u'awards_ptanumber', 'award_template_id')

        # Deleting field 'PTANumber.cfda_number'
        db.delete_column(u'awards_ptanumber', 'cfda_number_id')

        # Deleting field 'PTANumber.eas_award_type'
        db.delete_column(u'awards_ptanumber', 'eas_award_type')

        # Deleting field 'PTANumber.start_date'
        db.delete_column(u'awards_ptanumber', 'start_date')

        # Deleting field 'PTANumber.end_date'
        db.delete_column(u'awards_ptanumber', 'end_date')

        # Deleting field 'PTANumber.final_reports_due_date'
        db.delete_column(u'awards_ptanumber', 'final_reports_due_date')

        # Deleting field 'PTANumber.federal_negotiated_rate'
        db.delete_column(u'awards_ptanumber', 'federal_negotiated_rate_id')

        # Deleting field 'PTANumber.indirect_cost_schedule'
        db.delete_column(u'awards_ptanumber', 'indirect_cost_schedule_id')

        # Deleting field 'PTANumber.sp_type'
        db.delete_column(u'awards_ptanumber', 'sp_type')

        # Deleting field 'PTANumber.short_name'
        db.delete_column(u'awards_ptanumber', 'short_name')

        # Deleting field 'PTANumber.award_setup_complete'
        db.delete_column(u'awards_ptanumber', 'award_setup_complete')

        # Deleting field 'PTANumber.agency_award_number'
        db.delete_column(u'awards_ptanumber', 'agency_award_number')

        # Deleting field 'PTANumber.sponsor_award_number'
        db.delete_column(u'awards_ptanumber', 'sponsor_award_number')

        # Deleting field 'PTANumber.eas_status'
        db.delete_column(u'awards_ptanumber', 'eas_status')
