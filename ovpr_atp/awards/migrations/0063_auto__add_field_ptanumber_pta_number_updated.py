...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PTANumber.pta_number_updated'
        db.add_column(u'awards_ptanumber', 'pta_number_updated',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PTANumber.pta_number_updated'
        db.delete_column(u'awards_ptanumber', 'pta_number_updated')
