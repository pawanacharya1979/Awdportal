...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AwardSetup.ready_for_eas_setup'
        db.alter_column(u'awards_awardsetup', 'ready_for_eas_setup', self.gf('django.db.models.fields.CharField')(default='', max_length=3))

        # Changing field 'PTANumber.ready_for_eas_setup'
        db.alter_column(u'awards_ptanumber', 'ready_for_eas_setup', self.gf('django.db.models.fields.CharField')(default='', max_length=3))

    def backwards(self, orm):

        # Changing field 'AwardSetup.ready_for_eas_setup'
        db.alter_column(u'awards_awardsetup', 'ready_for_eas_setup', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'PTANumber.ready_for_eas_setup'
        db.alter_column(u'awards_ptanumber', 'ready_for_eas_setup', self.gf('django.db.models.fields.NullBooleanField')(null=True))
