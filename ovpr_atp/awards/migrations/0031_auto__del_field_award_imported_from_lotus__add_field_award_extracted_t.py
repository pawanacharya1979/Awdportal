...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Award.imported_from_lotus'
        db.delete_column(u'awards_award', 'imported_from_lotus')

        # Adding field 'Award.extracted_to_eas'
        db.add_column(u'awards_award', 'extracted_to_eas',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Award.imported_from_lotus'
        db.add_column(u'awards_award', 'imported_from_lotus',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Award.extracted_to_eas'
        db.delete_column(u'awards_award', 'extracted_to_eas')
