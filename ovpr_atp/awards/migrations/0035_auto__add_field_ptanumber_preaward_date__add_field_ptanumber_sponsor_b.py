...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PTANumber.preaward_date'
        db.add_column(u'awards_ptanumber', 'preaward_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PTANumber.sponsor_banner_number'
        db.add_column(u'awards_ptanumber', 'sponsor_banner_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PTANumber.preaward_date'
        db.delete_column(u'awards_ptanumber', 'preaward_date')

        # Deleting field 'PTANumber.sponsor_banner_number'
        db.delete_column(u'awards_ptanumber', 'sponsor_banner_number')
