...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NegotiationStatus.negotiation_status_date'
        db.alter_column(u'awards_negotiationstatus', 'negotiation_status_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'NegotiationStatus.negotiation_status_date'
        db.alter_column(u'awards_negotiationstatus', 'negotiation_status_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
