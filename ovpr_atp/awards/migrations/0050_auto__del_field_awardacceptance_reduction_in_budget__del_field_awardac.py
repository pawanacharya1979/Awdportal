...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AwardAcceptance.reduction_in_budget'
        db.delete_column(u'awards_awardacceptance', 'reduction_in_budget')

        # Deleting field 'AwardAcceptance.expedited_review'
        db.delete_column(u'awards_awardacceptance', 'expedited_review')

        # Deleting field 'AwardAcceptance.major_project'
        db.delete_column(u'awards_awardacceptance', 'major_project')


    def backwards(self, orm):
        # Adding field 'AwardAcceptance.reduction_in_budget'
        db.add_column(u'awards_awardacceptance', 'reduction_in_budget',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AwardAcceptance.expedited_review'
        db.add_column(u'awards_awardacceptance', 'expedited_review',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AwardAcceptance.major_project'
        db.add_column(u'awards_awardacceptance', 'major_project',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)
