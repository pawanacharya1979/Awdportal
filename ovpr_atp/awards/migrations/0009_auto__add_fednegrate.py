...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FedNegRate'
        db.create_table(u'awards_fednegrate', (
        ...
        db.send_create_signal(u'awards', ['FedNegRate'])


    def backwards(self, orm):
        # Deleting model 'FedNegRate'
        db.delete_table(u'awards_fednegrate')
