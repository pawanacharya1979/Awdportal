...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AwardManager.title'
        db.add_column(u'awards_awardmanager', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AwardManager.first_name'
        db.add_column(u'awards_awardmanager', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'AwardManager.middle_name'
        db.add_column(u'awards_awardmanager', 'middle_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'AwardManager.last_name'
        db.add_column(u'awards_awardmanager', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'AwardManager.phone'
        db.add_column(u'awards_awardmanager', 'phone',
        ...
        # Adding field 'AwardManager.email'
        db.add_column(u'awards_awardmanager', 'email',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


        # Renaming column for 'ProposalIntake.principal_investigator' to match new field type.
        db.rename_column(u'awards_proposalintake', 'principal_investigator', 'principal_investigator_id')
        # Changing field 'ProposalIntake.principal_investigator'
        db.alter_column(u'awards_proposalintake', 'principal_investigator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['awards.AwardManager'], null=True))
        # Adding index on 'ProposalIntake', fields ['principal_investigator']
        db.create_index(u'awards_proposalintake', ['principal_investigator_id'])


    def backwards(self, orm):
        # Removing index on 'ProposalIntake', fields ['principal_investigator']
        db.delete_index(u'awards_proposalintake', ['principal_investigator_id'])
        ...
        # Changing field 'Proposal.principal_investigator'
        db.alter_column(u'awards_proposal', 'principal_investigator_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['awards.PrincipalInvestigator'], unique=True, null=True, on_delete=models.SET_NULL))
        # Deleting field 'AwardManager.title'
        db.delete_column(u'awards_awardmanager', 'title')

        # Deleting field 'AwardManager.first_name'
        db.delete_column(u'awards_awardmanager', 'first_name')

        # Deleting field 'AwardManager.middle_name'
        db.delete_column(u'awards_awardmanager', 'middle_name')

        # Deleting field 'AwardManager.last_name'
        db.delete_column(u'awards_awardmanager', 'last_name')

        # Deleting field 'AwardManager.phone'
        db.delete_column(u'awards_awardmanager', 'phone')

        # Deleting field 'AwardManager.fax'
        db.delete_column(u'awards_awardmanager', 'fax')

        # Deleting field 'AwardManager.email'
        db.delete_column(u'awards_awardmanager', 'email')


        # Renaming column for 'ProposalIntake.principal_investigator' to match new field type.
        db.rename_column(u'awards_proposalintake', 'principal_investigator_id', 'principal_investigator')
        # Changing field 'ProposalIntake.principal_investigator'
        db.alter_column(u'awards_proposalintake', 'principal_investigator', self.gf('django.db.models.fields.CharField')(default='', max_length=150))
