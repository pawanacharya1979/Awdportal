...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EASMapping'
        db.create_table(u'awards_easmapping', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('interface', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('field', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('incoming_value', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('atp_model', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('atp_pk', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'awards', ['EASMapping'])

        # Adding unique constraint on 'EASMapping', fields ['interface', 'field', 'incoming_value', 'atp_model', 'atp_pk']
        db.create_unique(u'awards_easmapping', ['interface', 'field', 'incoming_value', 'atp_model', 'atp_pk'])


    def backwards(self, orm):
        # Removing unique constraint on 'EASMapping', fields ['interface', 'field', 'incoming_value', 'atp_model', 'atp_pk']
        db.delete_unique(u'awards_easmapping', ['interface', 'field', 'incoming_value', 'atp_model', 'atp_pk'])

        # Deleting model 'EASMapping'
        db.delete_table(u'awards_easmapping')
    ...
    models = {
        ...
        u'awards.easmapping': {
            ...
            'interface': ('django.db.models.fields.CharField', [], {'max_length': '1'})
        },
        u'awards.fednegrate': {
