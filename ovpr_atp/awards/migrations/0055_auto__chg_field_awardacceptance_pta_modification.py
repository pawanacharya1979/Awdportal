...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AwardAcceptance.pta_modification'
        db.alter_column(u'awards_awardacceptance', 'pta_modification', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'AwardAcceptance.pta_modification'
        db.alter_column(u'awards_awardacceptance', 'pta_modification', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'awards.awardacceptance': {
            ...
            'pta_modification': ('django.db.models.fields.NullBooleanField', [], {'default': 'True', 'null': 'True', 'blank': 'True'}),
