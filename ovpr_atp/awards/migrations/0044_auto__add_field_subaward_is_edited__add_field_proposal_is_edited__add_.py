...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subaward.is_edited'
        db.add_column(u'awards_subaward', 'is_edited',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Proposal.is_edited'
        db.add_column(u'awards_proposal', 'is_edited',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'AwardCloseout.is_edited'
        db.add_column(u'awards_awardcloseout', 'is_edited',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'AwardAcceptance.is_edited'
        db.add_column(u'awards_awardacceptance', 'is_edited',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'AwardNegotiation.is_edited'
        db.add_column(u'awards_awardnegotiation', 'is_edited',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'AwardSetup.is_edited'
        db.add_column(u'awards_awardsetup', 'is_edited',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ProposalIntake.is_edited'
        db.add_column(u'awards_proposalintake', 'is_edited',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'AwardManagement.is_edited'
        db.add_column(u'awards_awardmanagement', 'is_edited',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subaward.is_edited'
        db.delete_column(u'awards_subaward', 'is_edited')

        # Deleting field 'Proposal.is_edited'
        db.delete_column(u'awards_proposal', 'is_edited')

        # Deleting field 'AwardCloseout.is_edited'
        db.delete_column(u'awards_awardcloseout', 'is_edited')

        # Deleting field 'AwardAcceptance.is_edited'
        db.delete_column(u'awards_awardacceptance', 'is_edited')

        # Deleting field 'AwardNegotiation.is_edited'
        db.delete_column(u'awards_awardnegotiation', 'is_edited')

        # Deleting field 'AwardSetup.is_edited'
        db.delete_column(u'awards_awardsetup', 'is_edited')

        # Deleting field 'ProposalIntake.is_edited'
        db.delete_column(u'awards_proposalintake', 'is_edited')

        # Deleting field 'AwardManagement.is_edited'
        db.delete_column(u'awards_awardmanagement', 'is_edited')
    ...
    models = {
        ...
        u'awards.awardacceptance': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_edited': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
