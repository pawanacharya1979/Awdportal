...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AwardManager'
        db.create_table(u'awards_awardmanager', (
            ('id', self.gf('django.db.models.fields.BigIntegerField')(unique=True, primary_key=True)),
            ('full_name', self.gf('django.db.models.fields.CharField')(max_length=240)),
            ('gwid', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('system_user', self.gf('django.db.models.fields.BooleanField')()),
            ('end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'awards', ['AwardManager'])


    def backwards(self, orm):
        # Deleting model 'AwardManager'
        db.delete_table(u'awards_awardmanager')
