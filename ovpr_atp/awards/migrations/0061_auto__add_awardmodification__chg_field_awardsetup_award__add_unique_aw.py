...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AwardModification'
        db.create_table(u'awards_awardmodification', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comments', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('is_edited', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date_assigned', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ...
            ('eas_award_type', self.gf('django.db.models.fields.CharField')(max_length=2, blank=True)),
            ('sp_type', self.gf('django.db.models.fields.CharField')(max_length=3, blank=True)),
            ('indirect_cost_schedule', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['awards.IndirectCost'], null=True, blank=True)),
            ('allowed_cost_schedule', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['awards.AllowedCostSchedule'], null=True, blank=True)),
            ('cfda_number', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['awards.CFDANumber'], null=True, blank=True)),
            ('federal_negotiated_rate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['awards.FedNegRate'], null=True, blank=True)),
            ('property_equip_code', self.gf('django.db.models.fields.CharField')(max_length=2, blank=True)),
            ('onr_administered_code', self.gf('django.db.models.fields.CharField')(max_length=2, blank=True)),
            ('cost_sharing_code', self.gf('django.db.models.fields.CharField')(max_length=2, blank=True)),
            ('bill_to_address', self.gf('django.db.models.fields.TextField')(blank=True)),
            ...
            ('billing_events', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('document_number', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('nine_ninety_form_needed', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('task_location', self.gf('django.db.models.fields.CharField')(max_length=2, blank=True)),
            ('performance_site', self.gf('django.db.models.fields.CharField')(max_length=2, blank=True)),
            ...
            ('award_template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['awards.AwardTemplate'], null=True, blank=True)),
            ...
            ('ready_for_eas_setup', self.gf('django.db.models.fields.CharField')(max_length=3, blank=True)),
            ('wait_for', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'awards', ['AwardModification'])


        # Changing field 'AwardSetup.award'
        db.alter_column(u'awards_awardsetup', 'award_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['awards.Award'], unique=True))
        # Adding unique constraint on 'AwardSetup', fields ['award']
        db.create_unique(u'awards_awardsetup', ['award_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'AwardSetup', fields ['award']
        db.delete_unique(u'awards_awardsetup', ['award_id'])

        # Deleting model 'AwardModification'
        db.delete_table(u'awards_awardmodification')


        # Changing field 'AwardSetup.award'
        db.alter_column(u'awards_awardsetup', 'award_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['awards.Award']))
    ...
    models = {
        ...
        u'awards.awardacceptance': {
            ...
            'pta_modification': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'awards.awardmodification': {
            'Meta': {'object_name': 'AwardModification'},
