...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AwardCloseout.date_assigned'
        db.add_column(u'awards_awardcloseout', 'date_assigned',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'AwardNegotiation.date_assigned'
        db.add_column(u'awards_awardnegotiation', 'date_assigned',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AwardSetup.date_assigned'
        db.add_column(u'awards_awardsetup', 'date_assigned',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'AwardManagement.date_assigned'
        db.add_column(u'awards_awardmanagement', 'date_assigned',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AwardCloseout.date_assigned'
        db.delete_column(u'awards_awardcloseout', 'date_assigned')

        # Deleting field 'AwardAcceptance.date_assigned'
        db.delete_column(u'awards_awardacceptance', 'date_assigned')

        # Deleting field 'AwardNegotiation.date_assigned'
        db.delete_column(u'awards_awardnegotiation', 'date_assigned')

        # Deleting field 'AwardSetup.date_assigned'
        db.delete_column(u'awards_awardsetup', 'date_assigned')

        # Deleting field 'ProposalIntake.date_assigned'
        db.delete_column(u'awards_proposalintake', 'date_assigned')

        # Deleting field 'AwardManagement.date_assigned'
        db.delete_column(u'awards_awardmanagement', 'date_assigned')
