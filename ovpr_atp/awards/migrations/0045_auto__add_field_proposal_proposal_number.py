...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Proposal.proposal_number'
        db.add_column(u'awards_proposal', 'proposal_number',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Proposal.proposal_number'
        db.delete_column(u'awards_proposal', 'proposal_number')
