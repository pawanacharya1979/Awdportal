...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AllowedCostSchedule'
        db.create_table(u'awards_allowedcostschedule', (
            ('id', self.gf('django.db.models.fields.BigIntegerField')(unique=True, primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'awards', ['AllowedCostSchedule'])


    def backwards(self, orm):
        # Deleting model 'AllowedCostSchedule'
        db.delete_table(u'awards_allowedcostschedule')
