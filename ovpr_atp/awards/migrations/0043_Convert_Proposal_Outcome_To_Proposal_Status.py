...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for intake in orm.ProposalIntake.objects.all():
            intake.proposal_status = intake.proposal_outcome

            if intake.proposal_status == 'RJ':
                intake.proposal_outcome = 'UN'
                intake.proposal_status = 'SB'
            elif intake.proposal_status == 'AW':
                intake.proposal_status = 'SB'
            else:
                intake.proposal_outcome = ''

            intake.save()

    def backwards(self, orm):
        for intake in orm.ProposalIntake.objects.all():
            if intake.proposal_outcome == 'UN':
                intake.proposal_outcome = 'RJ'
            elif intake.proposal_outcome != 'AW':
                intake.proposal_outcome = intake.proposal_status

            intake.proposal_status = ''
            intake.save()
