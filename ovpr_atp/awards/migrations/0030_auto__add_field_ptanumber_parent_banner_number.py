...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PTANumber.parent_banner_number'
        db.add_column(u'awards_ptanumber', 'parent_banner_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PTANumber.parent_banner_number'
        db.delete_column(u'awards_ptanumber', 'parent_banner_number')
