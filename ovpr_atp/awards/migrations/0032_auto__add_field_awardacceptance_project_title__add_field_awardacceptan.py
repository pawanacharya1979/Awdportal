...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AwardAcceptance.project_title'
        db.add_column(u'awards_awardacceptance', 'project_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'AwardAcceptance.f_a_rate'
        db.add_column(u'awards_awardacceptance', 'f_a_rate',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'ProposalIntake.date_received'
        db.add_column(u'awards_proposalintake', 'date_received',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProposalIntake.five_days_requested'
        db.add_column(u'awards_proposalintake', 'five_days_requested',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProposalIntake.five_days_granted'
        db.add_column(u'awards_proposalintake', 'five_days_granted',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AwardAcceptance.project_title'
        db.delete_column(u'awards_awardacceptance', 'project_title')

        # Deleting field 'AwardAcceptance.f_a_rate'
        db.delete_column(u'awards_awardacceptance', 'f_a_rate')

        # Deleting field 'ProposalIntake.date_received'
        db.delete_column(u'awards_proposalintake', 'date_received')

        # Deleting field 'ProposalIntake.five_days_requested'
        db.delete_column(u'awards_proposalintake', 'five_days_requested')

        # Deleting field 'ProposalIntake.five_days_granted'
        db.delete_column(u'awards_proposalintake', 'five_days_granted')
