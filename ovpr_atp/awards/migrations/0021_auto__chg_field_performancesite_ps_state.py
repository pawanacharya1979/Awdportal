...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PerformanceSite.ps_state'
        db.alter_column(u'awards_performancesite', 'ps_state', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

    def backwards(self, orm):

        # Changing field 'PerformanceSite.ps_state'
        db.alter_column(u'awards_performancesite', 'ps_state', self.gf('django.db.models.fields.IntegerField')(null=True))
