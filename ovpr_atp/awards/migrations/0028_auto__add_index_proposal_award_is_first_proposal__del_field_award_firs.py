...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Proposal', fields ['award', 'is_first_proposal']
        db.create_index(u'awards_proposal', ['award_id', 'is_first_proposal'])

        # Deleting field 'Award.first_proposal'
        db.delete_column(u'awards_award', 'first_proposal_id')


    def backwards(self, orm):
        # Removing index on 'Proposal', fields ['award', 'is_first_proposal']
        db.delete_index(u'awards_proposal', ['award_id', 'is_first_proposal'])

        # Adding field 'Award.first_proposal'
        db.add_column(u'awards_award', 'first_proposal',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='award_first_proposal', null=True, on_delete=models.SET_NULL, to=orm['awards.Proposal'], blank=True, unique=True),
                      keep_default=False)
