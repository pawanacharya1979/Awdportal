...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IndirectCost'
        db.create_table(u'awards_indirectcost', (
            ('id', self.gf('django.db.models.fields.BigIntegerField')(unique=True, primary_key=True)),
            ('rate_schedule', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'awards', ['IndirectCost'])


    def backwards(self, orm):
        # Deleting model 'IndirectCost'
        db.delete_table(u'awards_indirectcost')
