...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProposalIntake.proposal_status'
        db.add_column(u'awards_proposalintake', 'proposal_status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2, blank=True),
                      keep_default=False)

        # Adding field 'ProposalIntake.proposal_number'
        db.add_column(u'awards_proposalintake', 'proposal_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProposalIntake.proposal_status'
        db.delete_column(u'awards_proposalintake', 'proposal_status')

        # Deleting field 'ProposalIntake.proposal_number'
        db.delete_column(u'awards_proposalintake', 'proposal_number')
