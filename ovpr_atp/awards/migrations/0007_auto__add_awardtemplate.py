...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AwardTemplate'
        db.create_table(u'awards_awardtemplate', (
        ...
        db.send_create_signal(u'awards', ['AwardTemplate'])


    def backwards(self, orm):
        # Deleting model 'AwardTemplate'
        db.delete_table(u'awards_awardtemplate')
