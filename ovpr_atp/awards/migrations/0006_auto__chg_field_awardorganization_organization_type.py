...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AwardOrganization.organization_type'
        db.alter_column(u'awards_awardorganization', 'organization_type', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'AwardOrganization.organization_type'
        raise RuntimeError("Cannot reverse this migration. 'AwardOrganization.organization_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'AwardOrganization.organization_type'
        db.alter_column(u'awards_awardorganization', 'organization_type', self.gf('django.db.models.fields.CharField')(max_length=30))
