...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PrimeSponsor'
        db.create_table(u'awards_primesponsor', (
            ('id', self.gf('django.db.models.fields.BigIntegerField')(unique=True, primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('number', self.gf('django.db.models.fields.IntegerField')()),
            ('active', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'awards', ['PrimeSponsor'])


    def backwards(self, orm):
        # Deleting model 'PrimeSponsor'
        db.delete_table(u'awards_primesponsor')
