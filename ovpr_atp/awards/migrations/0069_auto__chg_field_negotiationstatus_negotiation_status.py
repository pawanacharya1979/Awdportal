...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NegotiationStatus.negotiation_status'
        db.alter_column(u'awards_negotiationstatus', 'negotiation_status', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'NegotiationStatus.negotiation_status'
        db.alter_column(u'awards_negotiationstatus', 'negotiation_status', self.gf('django.db.models.fields.CharField')(max_length=3))
    ...
    models = {
        ...
        u'awards.negotiationstatus': {
            ...
            'negotiation_status_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'})
        },
