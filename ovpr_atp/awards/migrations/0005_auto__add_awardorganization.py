...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AwardOrganization'
        db.create_table(u'awards_awardorganization', (
            ...
            ('organization_type', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('org_info1_meaning', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('org_info2_meaning', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'awards', ['AwardOrganization'])


    def backwards(self, orm):
        # Deleting model 'AwardOrganization'
        db.delete_table(u'awards_awardorganization')
    ...
    models = {
        ...
        u'awards.awardorganization': {
            ...
            'organization_type': ('django.db.models.fields.CharField', [], {'max_length': '30'})
        },
        u'awards.awardsetup': {
